...
// Uses top-level await to ensure data is in memory before any request handler runs
let mongoPreloadDone = false;
if (process.env.MONGODB_URI) {
  try {
    ...
    console.error("DataStore preload failed:", e);
  }
  mongoPreloadDone = true;
}
