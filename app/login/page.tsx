      ...
      <div className="w-full max-w-[520px] relative z-10 animate-[fadeIn_0.6s_ease-out]">
        <section className="w-full rounded-[20px] border border-[#E5E7EB] bg-white p-10 shadow-sm">
          ...
          <div className="text-center mb-8">
            <h1 className="text-[32px] font-bold text-[#111827] mb-2">Bienvenue !</h1>
            <p className="text-[#64748B]">Connectez-vous à votre espace AgencyFlow pour gérer vos projets, équipes et clients.</p>
          </div>

          {/* Register link */}
          <p className="text-center text-sm text-[#64748B] mb-6">
            Vous n'avez pas encore de compte ?{" "}
            <Link href="/register" className="text-[#6D28FF] font-medium hover:underline">
              S'inscrire
            </Link>
          </p>
